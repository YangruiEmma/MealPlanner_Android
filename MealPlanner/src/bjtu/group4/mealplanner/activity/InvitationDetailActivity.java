...
public class InvitationDetailActivity extends Activity{
	...
	private class InvitationReplayTask extends AsyncTask<Object, Integer, Integer>{
		...
		protected void onPostExecute(Integer result) {
			...
			switch(response){
			case 1://³É¹¦
				Toast.makeText(InvitationDetailActivity.this, "³É¹¦¾Ü¾øÑûÇë", Toast.LENGTH_SHORT).show();;
				...
				break;
			case 0://Ê§°Ü
				Toast.makeText(InvitationDetailActivity.this, "²Ù×÷Ê§°Ü", Toast.LENGTH_LONG).show();
				break;
			}
		}
	}
